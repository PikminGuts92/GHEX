...
class Class106
{
    ...
    internal void method_2(float[] float_4, float[] float_5)
    {
    }

    [MethodImpl(MethodImplOptions.Synchronized)]
    internal void method_3(float[] float_4, float[] float_5)
    {
        ...
        float[] array2 = this.method_4(array, float_6, this.int_0, num, num2, num3);
        int num7 = 0;
        int num8 = num;
        int num9 = num2;
        int num10 = num9 - 1;
    ...
    internal float[] method_4(float[] float_4, float[] float_5, int int_3, int int_4, int int_5, int int_6)
    {
        int num = int_5;
        int num2 = 0;
        int num3 = int_4;
    ...
    float[] float_2 = new float[1024];

    float[] float_3 = new float[1024];
}
