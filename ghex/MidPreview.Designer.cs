...
public class MidPreview : UserControl
{
    ...
    void btnExport_Click(object sender, EventArgs e)
    {
        ...
        this.saveFileDialog_0.InitialDirectory = Settings.GetGlobalSettings().method_8().method_1("MidExport");
        if (this.saveFileDialog_0.ShowDialog() != DialogResult.OK)
        {
            return;
        }
        Settings.GetGlobalSettings().method_8().method_2("MidExport", Class109.smethod_5(this.saveFileDialog_0.FileName));
