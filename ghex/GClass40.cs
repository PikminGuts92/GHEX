...
{
	public GClass40(GClass104 gclass104_1, int int_1, SortOrder sortOrder_1) : base(gclass104_1, int_1, sortOrder_1)
	{
	}
	...
	public override int Compare(object object_0, object object_1)
	{
		...
		return Convert.ToDateTime(gclass.method_7()).CompareTo(Convert.ToDateTime(gclass2.method_7()));
	}
}
