...
public partial class MainWindow : Form
{
    public MainWindow()
    {
        ...
        if (Settings.GetGlobalSettings().method_4().ContainsKey("MainWindowSplit"))
        {
            Rectangle rectangle = Settings.GetGlobalSettings().method_4()["MainWindowSplit"];
    ...
    void MainWindow_Shown(object sender, EventArgs e)
    {
        ...
        ArchiveSource[] array = Settings.GetGlobalSettings().GetSources().ToArray();
        foreach (ArchiveSource @class in array)
        {
            this.method_17(@class.Path, @class.Active, @class.Verified);
        }
    ...
    bool method_15(TreeNode treeNode_0)
    {
        ...
        if (@class.gclass128_0.GetArkEntries().Count == 0)
        {
            if (!@class.gclass128_0.method_4())
            {
                ...
                if (@class.gclass128_0.method_4())
                {
                    Settings.GetGlobalSettings().GetSources().method_1(@class.gclass128_0.GetHdrPath()).Verified = @class.gclass128_0.method_14();
                }
            }
    ...
    TreeNode method_16(ArkFile gclass128_0)
    {
        ...
        if (!Settings.GetGlobalSettings().GetSources().method_0(gclass128_0.GetHdrPath()))
        {
            ...
            foreach (ArchiveSource @class in Settings.GetGlobalSettings().GetSources())
            {
                @class.Active = false;
            }
            Settings.GetGlobalSettings().GetSources().Add(new ArchiveSource(gclass128_0.GetHdrPath(), true, 0UL));
        }
        return treeNode;
    }
    ...
    {
        this.openFileDialog_0.InitialDirectory = Settings.GetGlobalSettings().method_8().method_1("LocateArchive");
        DialogResult dialogResult = this.openFileDialog_0.ShowDialog();
        if (dialogResult != DialogResult.OK)
        {
            return;
        }
        if (Settings.GetGlobalSettings().GetSources().method_0(this.openFileDialog_0.FileName))
        {
            MessageBox.Show("Archive already in list");
            return;
        }
        Settings.GetGlobalSettings().method_8().method_2("LocateArchive", Class109.smethod_5(this.openFileDialog_0.FileName));
    ...
    void method_20(TreeNode treeNode_0)
    {
        if (treeNode_0.Tag is ArkFile)
        {
            ...
            if (!Settings.GetGlobalSettings().GetSources().method_2(gclass.GetHdrPath()))
            {
                return;
            }
        ...
        {
            Settings.GetGlobalSettings().GetSources().method_2(treeNode_0.Text);
        }
    ...
    void cmArkFileList_Opening(object sender, CancelEventArgs e)
    {
        ...
        if (selectedNode.Tag is ArkFile)
        {
            ...
            if (selectedNode.Parent == null && Settings.GetGlobalSettings().GetSources().method_0(gclass.GetHdrPath()))
            {
    ...
    void MainWindow_FormClosed(object sender, FormClosedEventArgs e)
    {
        foreach (object obj in this.arkFileList.Nodes)
        {
            ...
            if (treeNode.Tag is ArkFile)
            {
                ...
                if (gclass.GetArkEntries().Count > 0)
                {
                    Settings.GetGlobalSettings().GetSources().method_1(gclass.GetHdrPath()).Active = treeNode.IsExpanded;
                    Settings.GetGlobalSettings().GetSources().method_1(gclass.GetHdrPath()).Verified = (gclass.method_4() ? gclass.method_14() : 0UL);
                    this.method_21(gclass);
                }
            }
        }
        Settings.GetGlobalSettings().method_4()["MainWindow"] = base.Bounds;
        Settings.GetGlobalSettings().method_4()["MainWindowSplit"] = new Rectangle(0, 0, this.splitContainer1.SplitterDistance, this.scPreview.SplitterDistance);
    }
    ...
    void cmiFileListReplace_Click(object sender, EventArgs e)
    {
        ...
        @class.openFileDialog_0.InitialDirectory = Settings.GetGlobalSettings().method_8().method_1("FileReplace");
        if (@class.openFileDialog_0.ShowDialog() != DialogResult.OK)
        {
            return;
        }
        Settings.GetGlobalSettings().method_8().method_2("FileReplace", Class109.smethod_5(@class.openFileDialog_0.FileName));
        TreeNode selectedNode = this.arkFileList.SelectedNode;
    ...
    void timer_0_Tick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Settings.GetGlobalSettings().SetProductVersion(value);
            ...
            if (Settings.GetGlobalSettings().GetProductVersion().CompareTo(Application.ProductVersion) == 0)
            {
                Settings.GetGlobalSettings().SetProductVersion("");
    ...
    void cmiFileListExtract_Click(object sender, EventArgs e)
    {
        ...
        if (@class.treeNode_0.Tag is ArkEntry)
        {
            ...
            class2.saveFileDialog_0.InitialDirectory = Settings.GetGlobalSettings().method_8().method_1("ExtractFile");
            if (class2.saveFileDialog_0.ShowDialog() != DialogResult.OK)
            {
                return;
            }
            Settings.GetGlobalSettings().method_8().method_2("ExtractFile", Class109.smethod_5(class2.saveFileDialog_0.FileName));
            ProgressDialog progressDialog = new ProgressDialog(new ProgressDialog.GDelegate6(class2.method_0));
            progressDialog.ShowDialog();
            return;
        }
        else
        {
            if (!(@class.treeNode_0.Tag is Class98))
            {
                if (@class.treeNode_0.Tag == null)
                {
                    ...
                    class3.folderBrowserDialog_0.SelectedPath = Settings.GetGlobalSettings().method_8().method_1("ExtractFile");
                    if (class3.folderBrowserDialog_0.ShowDialog() != DialogResult.OK)
                    {
                        return;
                    }
                    Settings.GetGlobalSettings().method_8().method_2("ExtractFile", class3.folderBrowserDialog_0.SelectedPath);
                    class3.long_0 = 0L;
            ...
            class4.saveFileDialog_0.InitialDirectory = Settings.GetGlobalSettings().method_8().method_1("ExtractFile");
            if (class4.saveFileDialog_0.ShowDialog() != DialogResult.OK)
            {
                return;
            }
            Settings.GetGlobalSettings().method_8().method_2("ExtractFile", Class109.smethod_5(class4.saveFileDialog_0.FileName));
    ...
    void cmiFileListExportNoteCharts_Click(object sender, EventArgs e)
    {
        ...
        @class.folderBrowserDialog_0.SelectedPath = Settings.GetGlobalSettings().method_8().method_1("BatchExport");
        if (@class.folderBrowserDialog_0.ShowDialog() != DialogResult.OK)
        {
            return;
        }
        Settings.GetGlobalSettings().method_8().method_2("BatchExport", @class.folderBrowserDialog_0.SelectedPath);
    ...
    void cmiFileListImport_Click(object sender, EventArgs e)
    {
        ...
        else if (string.Compare(strA, "mid", true) == 0)
        {
            ...
            openFileDialog.InitialDirectory = Settings.GetGlobalSettings().method_8().method_1("MidImport");
            openFileDialog.Filter = "Supported files|*.mid;*.sng;*.chart;song.ini";
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                Settings.GetGlobalSettings().method_8().method_2("MidImport", Class109.smethod_5(openFileDialog.FileName));
