...
public partial class VgsImportDialog : Form
{
    ...
    {
        this.openFileDialog_0.InitialDirectory = Settings.GetGlobalSettings().method_8().method_1("VgsImport");
        if (this.openFileDialog_0.ShowDialog() != DialogResult.OK)
        {
            return;
        }
        Settings.GetGlobalSettings().method_8().method_2("VgsImport", Class109.smethod_5(this.openFileDialog_0.FileNames[0]));
