...
public class GClass53 : GInterface7
{
	...
	public GClass53(GClass114 gclass114_1, int int_1, bool bool_1)
	{
	...
	public void imethod_3()
	{
		...
		gclass.method_3(gclass.method_2() - this.int_0);
	}
	...
	{
		return "Move Event " + this.gclass114_0.ToString();
	}
